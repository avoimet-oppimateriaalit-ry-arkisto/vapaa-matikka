...
Luvun toista potenssia $a^2$ kutsutaan myös luvun $a$ \emph{neliöksi} ja kolmatta potenssia $a^3$ sen \emph{kuutioksi}. Luvun $a>0$ neliö on sellaisen neliön pinta-ala, jonka sivun pituus on $a$. Vastaavasti, jos kuution särmän pituus on $a$, on $a^3$ kyseisen kuution tilavuus.  
    ...
    \begin{esimerkki}
        ...
        \begin{alakohdat}
            \alakohta{$(-2)^3 = (-2)\cdot (-2)\cdot (-2) = -8$}
            \alakohta{$(-2)^4 = (-2)\cdot (-2)\cdot (-2)\cdot (-2) = 16$}
            \alakohta{$-2^4   = -(2^4) = -(2\cdot 2\cdot 2\cdot 2) = -16$}
            \alakohta{$2^2\cdot 2^3 = \underbrace{2\cdot 2}_{\text{$2$ kpl}}\cdot \underbrace{2\cdot 2\cdot 2}_{\text{$3$ kpl}} = \underbrace{2\cdot 2\cdot 2\cdot 2\cdot 2}_{\text{$5$ kpl}}=2^5 = 32$}
            \alakohta{ $\displaystyle\frac{2^4\cdot 2^2}{2^3} = \frac{2\cdot 2\cdot 2\cdot \cancel{2} \cdot \cancel{2}\cdot \cancel{2}}{\cancel{2}\cdot \cancel{2}\cdot \cancel{2}} = 2^3 = 8$}
        \end{alakohdat}
    \end{esimerkki}
...
(ab^5)^3=ab^5\cdot ab^5\cdot ab^5=a\cdot a\cdot a\cdot b^5\cdot b^5\cdot b^5=a^{\mathbf{1\cdot 3}}\cdot b^{\mathbf{5\cdot 3}}=a^3b^{15}
    ...
    \laatikko{
        ...
        Olkoot $m$ ja $n$ kokonaislukuja ja $a$ rationaaliluku.
