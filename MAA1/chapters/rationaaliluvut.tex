...
Lukumäärää esittävät luvut 0, 1, 2, 3, ... muodostavat \termi{luonnollinen luku}{luonnollisten lukujen} joukon $\N$.
Joukkoja merkitään listaamalla niiden alkiot aaltosuluissa, eli merkitään
\[\N=\{0, 1, 2, 3, \ldots \} \]

Kun luonnollisten lukujen joukkoa täydennetään luonnolisten lukujen vastaluvuilla, saadaan \termi{kokonaisluku}{kokonaislukujen} joukko $\Z$.
...
\begin{esimerkki}
Kuinka lasketaan jakolasku $\frac 1 5 : \frac 2 3$, eli kuinka murtoluvulla jaetaan? Huomataan ensin, että $\frac 1 5 = \frac 1 5 \cdot 1$, sillä ykkösellä kertominen ei muuta lukua. Edelleen, koska $\frac 3 2$ ja $\frac 2 3$ ovat toistensa käänteislukuja, on niiden tulo 1. Siis voidaan kirjoittaa
\[
	\frac 1 5 = \frac 1 5 \cdot \underbrace{\frac 3 2 \cdot \frac 2 3}_{=1}.
\]
Jos nyt jaetaan tämän yhtälön vasen ja oikea puoli kummatkin $\frac 2 3$:lla, saadaan
\[
	\frac 1 5 : \frac 2 3 = \frac 1 5 \cdot \frac 3 2 \cdot \underbrace{\frac 2 3 : \frac 2 3}_{=1}.
\]
Koska luku jaettuna itsellään on 1, voidaan edellinen yhtälö kirjoittaa muotoon
\[
	\frac 1 5 : \frac 2 3 = \frac 1 5 \cdot \frac 3 2.
\]
Tästä selviääkin vastaus alkuperäiseen kysymykseen: jakolasku $\frac 1 5 : \frac 2 3$ lasketaan kertomalla jaettava $\frac 1 5$ jakajan $\frac 2 3$ käänteisluvulla $\frac 3 2$. Siis $\frac 1 5 : \frac 2 3 = \frac 1 5 \cdot \frac 3 2 = \frac{3}{10}$.
\end{esimerkki}

\laatikko{%
Murtolukujen $\frac a b$ ja $\frac c d$ jakolasku muutetaan kertolaskuksi vaihtamalla jakaja käänteisluvukseen:
\[
