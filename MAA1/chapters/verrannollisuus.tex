...
\begin{vastaus}
Seitsemällä opiskelijalla työ valmistuu noin 14~tunnissa. Työ valmistuu 9~tunnissa, jos opiskelijoita on  12.
\end{vastaus}
\end{tehtava}

\begin{tehtava}
Kappaleen liike-energia on suoraan verrannollinen nopeuden neliöön. Kun kappale liikkui nopeudella 8,0~m/s, sen liike-energia oli 160~joulea. Laske kappaleen liike-energia, kun sen nopeus on 6,0~m/s. 
\begin{vastaus}
90~J
\end{vastaus}
\end{tehtava}
