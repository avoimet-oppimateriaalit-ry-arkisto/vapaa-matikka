...
\begin{tehtava}
Ratkaise yhtälö. Tarkista laskimella tai tietokoneella. % Lukion Calculus 1, osia tehtävistä 49 ja 48.
\begin{alakohdat}
	\alakohta{$-3x+4=3(4+x)$}
	\alakohta{$3(x-1) - 2x = 13-3x$}
	\alakohta{$6 - (x+4) = 2-x$}
	\alakohta{$x - 10\,000 = -0,6x$}
	\alakohta{$10^5 x - 5 \cdot 10^8 = 0$}
	\alakohta{$2(x-1) = 2x-1$}
\end{alakohdat}
%
\begin{vastaus}
\begin{alakohdat}
	\alakohta{$x=-1\frac 1 3$}
	\alakohta{$x=4$}
...
\begin{tehtava}
Ratkaise yhtälö. Tarkista laskimella tai tietokoneella.% Lukion Calculus 1, osia eri tehtävistä 
\begin{alakohdat}
	\alakohta{$\dfrac{7x}{6} = 14$}
	\alakohta{$2 - \dfrac{x}{3} = x$}
	\alakohta{$-\dfrac{9x}{11} = x+1$}
	\alakohta{$x+3 = 1 - \dfrac{x-3}{2}$}
	\alakohta{$\dfrac{2x-1}{2} - 1 = \dfrac{5x}{6}$}
	\alakohta{$\dfrac{x+5}{3} = x+1-\dfrac{2x+1}{4}$}
\end{alakohdat}
%
\begin{vastaus}
\begin{alakohdat}
	\alakohta{$x=12$}
	\alakohta{$x=\frac 3 2$}
	\alakohta{$x=-\frac{11}{20}$}
	\alakohta{$x = -\frac 1 3$}
	\alakohta{$x=9$}
	\alakohta{$x=\frac{11}{2}$}
\end{alakohdat}
\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
Määritä luvulle $a$ sellainen arvo, että yhtälön $6x-6-2ax=5-x$ ratkaisu on $-1$. % Lukion Calculus 1, tehtävä 57 vaikeutettuna
\begin{vastaus}
$a=9$
\end{vastaus}
\end{tehtava}
