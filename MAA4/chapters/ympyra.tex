...
Tähän tarvitaan kuva origokeskisestä ympyrästä, jonka säde on kolme. Kuvaan voisi laittaa myös yhden ympyrän pisteen $(x,y)$.
...
Jos edellä säde $r$ on nolla, yhtälön toteuttaa vain piste $(x_{0},y_{0})$. Nollasäteinen ympyrä onkin vain piste.
...
Nyt huomataan, että kyseessä on $(-3,2)$-keskisen $4$-säteisen ympyrän yhtälöksi.
...
\begin{align*}
x^2-8x+y^2+5y+3&=0 \ppalkki +16\\
x^2-8x+16+y^2+5y&=-3+16 \\
(x^2-4)^2+y^2+5y&=13 \ppalkki +\frac{25}{4}\\
(x^2-4)^2+y^2+5y+\frac{25}{4}&=\frac{77}{4} \ppalkki +\frac{25}{4}\\
(x^2-4)^2+(y+\frac{5}{4})^2&=\frac{102}{4} \\
(x^2-4)^2+(y+\frac{5}{4})^2&=\frac{51}{2} \\
\end{align*}
Nähdään, että keskipiste on $(4,-5/4)$ ja säde on $\sqrt{51/2}$.
\end{esimratk}
\begin{esimvast}
Keskipiste on $(4,-5/4)$ ja säde on $\sqrt{51/2}$.
\end{esimvast}

\end{esimerkki}


Sama päättely voidaan suorittaa myös yleisesti muotoa
\[
x^2+ax+y^2+by+c = 0
\]
