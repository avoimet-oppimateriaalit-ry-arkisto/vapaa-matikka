...
\termi{polynomi}{Polynomit} ovat matematiikassa yleisiä yhden muuttujan laskulausekkeita.
...
Polynomilausekkeet ovat summia, joiden yhteenlaskettavia kutsutaan \termi{termi}{termeiksi}. (Termit, joita edeltää miinusmerkki, voidaan käsittää negatiivisten lukujen yhteenlaskuina.)
...
Yhden termin polynomeista käytetään erityisnimitystä \termi{monomi}{monomi}
ja kahden termin polynomi on puolestaan \termi{binomi}{binomi}.

Termin muuttujan eksponenttia kutsutaan termin \termi{aste}{asteeksi} tai \termi{asteluku}{asteluvuksi}.
...
Polynomi määrittää funktion, jota kutsutaan \termi{polynomifunktio}{polynomifunktioksi}. Esimerkiksi polynomi $2x^2+2x-1$ määrittää funktion $P(x)=2x^2+2x-1$. Tämän funktion arvoja voidaan laskea sijoittamalla lukuja muuttujan $x$ paikalle:
\begin{align*}
