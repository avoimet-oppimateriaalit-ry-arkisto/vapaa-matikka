...
\end{itemize}
Polynomeissa on muuttujien potenssien ($\in\N$) lisäksi ainoastaan vakiolla kertomista sekä yhteen- ja vähennyslaskua.
Polynomin yleinen muoto on $a_n x^n + a_{n-1} x^{n-1} + \ldots + a_1 x + a_0$, missä $n\in\N$ ja $a_i\in\R, i \in\{0, 1, \ldots, n-1, n\}$.
...
Siksi esimerkiksi polynomi $y^4+y^2-1$ voidaan kirjoittaa myös järjestyksessä $-1+y^4+y^2$.
