...
Polynomilausekkeet ovat käytännössä summia, joiden yhteenlaskettavia kutsutaan \termi[termeiksi]{termi}.
...
\termi[aste]{polynomi!aste} on suurin sen termien asteista.
...
Polynomi määrittää funktion, jota kutsutaan \termi[polynomifunktioksi]{polynomifunktio}. Esimerkiksi polynomi $2x^2+2x-1$ määrittää funktion $f(x)=2x^2+2x-1$. 
