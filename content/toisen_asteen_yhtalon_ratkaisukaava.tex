...
\begin{align*}
ax^2+bx+c&=0 &\emph{kerrotaan molemmat puolet vakiolla} \quad 4a \\
4a \cdot ax^2+4a \cdot bx + 4a \cdot c&=0 \\
4a^2x^2+4abx+4ac&=0 &\emph{vähennetään puolittain termi} \quad 4ac  \\
4a^2x^2+4abx&=-4ac
\end{align*}
Täydennetään vasen puoli binomin neliöksi.
\begin{align*}
4a^2x^2+4abx&=-4ac &\emph{lisätään puolittain termi} \quad b^2 \\
4a^2x^2+4abx+b^2&=b^2-4ac &\emph{nyt} \quad (2ax+b)^2=4a^2x^2+4abx+b^2 \\
(2ax+b)^2&=b^2-4ac &\emph{otetaan puolittain neliöjuuri} \\
2ax+b&= \pm \sqrt[]{b^2-4ac} &\emph{vähennetään puolittain termi} \quad b \\
2ax&=-b \pm \sqrt[]{b^2-4ac} &\emph{jaetaan puolittain termillä} \quad 2a \\
