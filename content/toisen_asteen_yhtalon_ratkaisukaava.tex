...
\end{align*}
Saimme johdettua toisen asteen yhtälön ratkaisukaavan. Ratkaisussa jouduimme olettamaan, että $b^2 \geq 4ac$, sillä emme pysty ottamaan negatiivisista luvuista neliöjuuria käyttämällä vain reaalilukuja. Mitään ongelmaa ei synny, jos käyttäisimme kompleksilukuja, mutta niiden käsittely ei kuulu tähän kurssiin.\\
\laatikko{\textbf{Toisen asteen yhtälön ratkaisukaava} \\
Yhtälön
$ax^2+bx+c=0$, missä  $a \neq 0$ ja   $b^2 \geq 4ac$, reaalijuuret ovat muotoa\\
\[ x=\frac{-b \pm \sqrt{b^2-4ac}}{2a}.\]
}
\begin{esimerkki}
...
\item
Jos $D=0$, yhtälöllä on tasan yksi reaalinen ratkaisu, niin sanottu \termi{kaksoisjuuri}.
\item
...
\parbox{6cm}{$f(x)=2x^2-2x+1$:\\$D < 0$, ei reaalisia ratkaisuja}
\\
\parbox{4.5cm}{
\begin{kuvaajapohja}{1}{-1}{3}{-1}{3}
...
\parbox{6cm}{$f(x)=x^2-2x+1$:\\$D = 0$, yksi reaaliratkaisu}
\\
\parbox{4.5cm}{
...
\parbox{6cm}{$f(x)=2x^2-4x+1$:\\$D > 0$, kaksi eri reaaliratkaisua}
\end{esimerkki}
