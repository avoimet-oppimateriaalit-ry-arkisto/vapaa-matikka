...
\laatikko{
    ...
    \begin{itemize}
        \item Jos tulossa ($\neq 0$) on parillinen $(0, 2, 4, \ldots)$ määrä negatiivisia tekijöitä, tulo on positiivinen.
        \begin{itemize}
	        \item Erityisesti, jos tulossa on vain positiivisia tekijöitä, tulo on positiivinen.
        \end{itemize}
        \item Jos tulossa ($\neq 0$) on pariton $(1, 3, 5, \ldots)$ määrä negatiivisia tekijöitä, tulo on negatiivinen.
    \end{itemize}
}
