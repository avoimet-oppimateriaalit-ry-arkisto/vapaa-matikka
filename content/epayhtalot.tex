...
Edellisen esimerkkiepäyhtälön kaikkien ratkaisujen joukon voi esittää myös seuraavasti: $x \in ]-\inf, 2]$. Tällaisessa \emph{reaalilukuvälin} merkinnässä ilmoitetaan muuttujalle sen pienin ja suurin mahdollinen arvo. Vasemmalta epäyhtälön toteuttavia $x$:n arvoja ei rajoita mikään, eli $x$ voi saada mielivaltaisen pieniä arvoja.
