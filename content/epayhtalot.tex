...
Epäyhtälön totuusarvo voi riippua epäyhtälön puolilla esiintyvien muuttujien arvoista. Epäyhtälöt jakautuvat seuraaviin tyyppeihin:
\begin{itemize}
\item Epäyhtälö on aina tosi. Esimerkiksi epäyhtälöt $5 < 6$ ja $x + 1 \leq x + 3$ pätevät riippumatta muuttujien arvoista.
\item Epäyhtälö on ehdollisesti tosi, eli se pätee vain joillain muuttujien arvoilla. Esimerkiksi $x < 5$ pätee, kun $x = 4$ mutta ei päde kun $x = 7$.
\item Epäyhtälö on aina epätosi. Esimerkiksi epäyhtälöt $1 > 3$ ja $x < x$ eivät päde millään muuttujien arvoilla.
\end{itemize}
