...
Yleensä \termi[epäyhtälöistä]{epäyhtälö} puhuttaessa viitataan erityisesti lausekkeisiin, joissa käytetään ''pienempi kuin''- ja ''pienempi tai yhtä suuri kuin'' -merkkiä ja niiden vastineita.
...
\begin{esimerkki}
Ratkaistaan epäyhtälö $1\leq q+7<-5q+4$.
