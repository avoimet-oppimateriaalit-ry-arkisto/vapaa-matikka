...
Yleensä epäyhtälöistä puhuttaessa viitataan erityisesti lausekkeisiin, joissa käytetään
pienempi kuin - ja pienempi tai yhtä suuri kuin -merkkiä ja niiden vastineita. \todo{Onko väliviivaa käytetty tässä lauseessa oikein?} Kielteisten muotojen käyttö on harvinaista.
