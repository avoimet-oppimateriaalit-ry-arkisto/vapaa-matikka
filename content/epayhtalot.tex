...
\begin{itemize}
\item \emph{Aina tosi} -- pätee kaikilla muuttujien arvoilla. Esimerkiksi epäyhtälöt $5 < 6$ ja $x + 1 \leq x + 3$ pätevät riippumatta muuttujien arvoista.
...
\item \emph{Aina epätosi} -- ei päde millään muuttujien arvoilla. Esimerkiksi epäyhtälöt $1 > 3$ ja $x < x$ eivät päde koskaan.
\end{itemize}

\subsection*{Epäyhtälöiden ratkaiseminen}
Vastaavasti kuin yhtälöiden ratkaiseminen, epäyhtälön ratkaiseminen tarkoittaa sellaisten muuttujien arvojen, joilla epäyhtälö on tosi, selvittämistä.
