...
{Opetusvideo \emph{polynomien kertolasku} (10:00)}
...
Opetusvideot \emph{muistikaavat} (8:05) sekä
 \emph{esimerkkejä muistikaavojen käytöstä} (6:38 ja 9:08)}
...
\begin{esimerkki}
Luvun $12$ voidaan kirjoittaa tekijöidensä tulona monella eri tavalla. Esimerkiksi
\begin{equation*}
12 = 2 \cdot 6, \ 12= 4 \cdot 3 \text{ ja } 12= 2 \cdot 2 \cdot 3.
%& 12 = 4 \cdot 3 = 2 \cdot 2 \cdot 3 = 2^2 \cdot 3
\end{equation*} 
\end{esimerkki}
...
\qrlinkki{http://opetus.tv/maa/maa2/polynomin-jakaminen-tekijoihin/}{Opetusvideot \emph{polynomin jakaminen tekijöihin} (9:50 ja 5:44)}
...
Kaikkien polynomien tekijöihinjako ei kuitenkaan näillä menetelmillä onnistu. Myöhemmin tässä kirjassa opitaan, miten toisen asteen polynomin voi jakaa tekijöihin nollakohtiensa avulla.
