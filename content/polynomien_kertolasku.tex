...
\pgfmathsetmacro{\klBx}{1.18}
\pgfmathsetmacro{\klCx}{1.79}
\pgfmathsetmacro{\klDx}{2.47}
\pgfmathsetmacro{\klEx}{3.23}
...
\todo{asemoi uudestaan kaarten päätepisteet, yleinen tapaus tehty,
	esimerkki tekemättä, onhan fontti nyt lopullinen?}
