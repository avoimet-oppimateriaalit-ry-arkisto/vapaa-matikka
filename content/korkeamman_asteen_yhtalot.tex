...
\begin{esimerkki}
Ratkaistaan yhtälö $x^3-17x^2+x-17 = 0$. Huomataan, että vasemman puolen polynomilla on tekijänä $x-17$, eli yhtälö voidaan kirjoittaa muodossa $(x-17)(x^2+1) = 0$. Siis yhtälö pätee täsmälleen silloin kun
\[x - 17 = 0 \text{ tai } x^2+1 = 0.\]
Ratkaisemalla yhtälöt saadaan, että alkuperäisen yhtälön ratkaisut ovat
\[x = 17 \text{ tai } x = \pm 1.\]
\end{esimerkki}
...
Nyt alkuperäisen yhtälön ratkaisut ovat yhtälön $y = x^2$ ratkaisut muuttujan $x$ suhteen, kun $y = 2$ ja kun $y = -9$. Reaaliluvun neliö ei ole koskaan negatiivinen, eli ainoat ratkaisut ovat yhtälön $x^2 = 2$ ratkaisut $x = \pm\sqrt{2}$.
\end{esimerkki}
