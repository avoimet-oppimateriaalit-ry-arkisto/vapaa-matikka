...
tekniikalla. Menetelmä perustuu seuraavaan havaintoon yhtälönratkaisusta: toisen asteen yhtälön yleisessä muodossa $ax^2+bx+c=0$ tuntematon $x$ esiintyy kahdesti, mikä tekee sen ratkaisemisesta hankalaa. Aiemmin opettelemamme muistikaavat kuten $x^2+2xy+y^2={(x+y)}^2=$ antavat meille kuitenkin keinon muuttaa yhtälö sellaiseen muotoon, jossa tuntematon esiintyy vain kerran ja on helpompi ratkaista.

Seuraavassa luvussa todistamme neliöön täydentämisen avulla
