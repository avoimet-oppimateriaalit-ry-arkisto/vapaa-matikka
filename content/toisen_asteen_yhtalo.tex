n asteen\chapter{Toisen asteen yhtälö}
\begin{esimerkki}
...
\end{tabular}
\todo{termi-komento ei toimi vaillinaisen ekvationin kohdalla}
...
Vain vakiotermi on siis ''pielessä''. Korjataan asia ja ratkaistaan yhtälö:
...
Miksi edellä osattiin ajatella juuri sopivaa muistikaavaa $(x+1)^2=x^2+2x+1$? Siksi, että yhtälön vasemmalla
puolella olleen polynomin alku $x^2+2x$ ei voi tulla mistään muustakaan binomin neliöstä.
Siksi vakiotermiä muutettiin sopivasti eli polynomi \emph{täydennettiin neliöksi}.

Neliöksi täydentäminen vaatii muistikaavojen hyvää hallintaa, mutta niiden avulla kaikki toisen asteen yhtälöt voidaan ratkaista neliöksi täydentämällä. (Yleensä tosin käytetään toisen asteen yhtälön ratkaisukaavaa, joka esitellään seuraavassa luvussa.)

\begin{esimerkki} (korjaa, turhan monimutkainen) \\
