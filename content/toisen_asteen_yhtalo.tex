...
$c = 0$ on kyseessä niin sanottu vaillinainen toisen asteen yhtälö, joka on
siis muotoa
\[ax^2+c=0\]
tai
\[ax^2+bx=0.\]
\subsection*{Toisen asteen yhtälö $ax^2+c=0$}
Muotoa $ax^2+c = 0$ oleva toisen asteen yhtälö saadaan ratkaistua neliöjuuren avulla.
...
Muotoa $ax^2+bx = 0$ oleva toisen asteen yhtälö saadaan ratkaistua tulon
nollasäännön avulla, koska yhtälö on muotoa $x(ax+b) = 0$ eli ratkaisut ovat
yhtälöiden $x = 0$ ja $ax+b=0$ ratkaisut.

\begin{esimerkki}
Ratkaistaan yhtälö $x^2-11x=0$:
\begin{align*}
x^2 - 11x &= 0 &&x^2-11x = x(x-11) \\
...
\begin{align*}
55x^2+8x &= 0 &&x^2-11x = x(55x+8) \\
x(55x+8) &= 0 &&\text{tulon nollasääntö} \\
x &= 0 \text{\ \ \ tai\ \ \ } 55x + 8 = 0 &&\ppalkki - 8 \text{ (toinen yhtälö)} \\
x &= 0 \text{\ \ \ tai\ \ \ } 55x = -8 &&\ppalkki : 55 \text{ (toinen yhtälö)} \\
