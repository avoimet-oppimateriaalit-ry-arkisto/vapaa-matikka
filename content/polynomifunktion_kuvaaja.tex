...
Itse asiassa edllinen kuvaaja kuuluu funktiolle $P(x)=x^4-2x^3-x^2+\dfrac{11}{10}$. Nyt tiedetään, että funktion $P(x)$ arvo kohdassa $x=1$ on $-\dfrac{9}{10}$ eikä $-1$, kuten kuvaajan perusteella voisi luulla. Kuvaajasta ei siis voi lukea tarkkoja tietoja funktiosta.
\end{esimerkki}
...
\kuvaaja{1./3*x**2-4*x+5./2}{$P(x) = \dfrac{1}{3}x^2-4x+\dfrac{5}{2}$}{red}
\end{kuvaajapohja}
\end{esimerkki}
