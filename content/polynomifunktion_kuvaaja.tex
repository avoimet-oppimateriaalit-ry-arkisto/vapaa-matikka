...
Funktioiden kuvaaajia voi piirtää laskimella tai tietokoneella. Kuvaajaa voi myös hahmotella käsin laskemalla ensin funktion arvoja muutamilla muuttujan arvoilla, merkitsemällä pisteet
$xy$-koordinaatistoon ja piirtämällä lopuksi pisteiden kautta kulkeva kuvaajan.
...
\begin{tabular}{c c c}
	...
	\kuvaajapiste{2}{-2}
	\kuvaajapiste{3}{-0.5}
	\kuvaaja{0.5*x**2-x-2}{$f(x) = \dfrac{1}{2}x^2 - x - 2$}{black}
	\end{kuvaajapohja}}
\end{tabular}

\end{esimerkki}

\qrlinkki{http://opetus.tv/maa/maa2/suoran-piirtaminen/}{Opetusvideo \emph{suoran piirtäminen} (5:47)}
...
\kuvaaja{x**4-2*x**3-x**2+11./10}{$P(x)$}{black}
\end{kuvaajapohja}
