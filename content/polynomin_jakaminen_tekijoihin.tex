...
x&=1 \textrm{ tai } x = 2.
\end{align*}
Tämän perusteella voidaan päätellä, että $x-1$ ja $x-2$ ovat polynomin $P()$ tekijöitä. Toden totta: sulut auki kertomalla voidaan tarkistaa, että $(x-1)(x-2)=x^2-3x+2$.

\laatikko{\textbf{Polynomien jakolause} \\
Jos $x=b$ on polynomin nollakohta, $x-b$ on polynomin tekijä.}

\textbf{Todistus.} Jakolauseen todistus perustuu polynomien jakoyhtälöön, josta tarkemmin kurssilla 12. Vaikka lauseke $x-b$ ei olisi polynomin $P(x)$ tekijä, mutta lähelle päästään: jos polynomi $Q(x)$ valitaan sopivasti, voidaan kirjoittaa
\begin{align*}
P(x)&=(x-b)Q(x)+r, 
\end{align*}
...
Puuttuu vielä korkeimman asteen termin kerroin $-2$. Sillä kertomalla saadaan oikea tulos:
