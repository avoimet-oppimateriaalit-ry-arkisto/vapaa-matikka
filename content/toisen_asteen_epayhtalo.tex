...
\begin{kuvaajapohja}{0.3}{-5}{5}{-5}{5}
...
\begin{esimerkki}
Millä muuttujan $x$ arvoilla funktion $f(x)=5x^2+13x+3$ arvot ovat negatiivisia?
...
\textbf{Vastaus:}
Funktion $f(x)=5x^2+13x+3$ arvot ovat negatiivisia, kun $\frac{-13 - \sqrt[]{109}}{10}<x< \frac{-13 + \sqrt[]{109}}{10}$.

\end{esimerkki}

\begin{esimerkki} 
Ratkaise epäyhtälö $x^2+5x<6$.

\textbf{Ratkaisu:}
Muutetaan ensin epäyhtälö muotoon $x^2+5x-6<0$. Nyt tehtävä voidaan ratkaista tutkimalla, millä muuttujan arvoilla funktion $f(x)=x^2+5x-6$ arvot ovat negatiivisia.
...
\begin{esimerkki}
Raaka-Arska rakentaa suorakulmion muotoista kaniaitausta lemmikkikanilleen. Aitaus rajoittuu yhdeltä sivulta Arskan taloon. Hänellä on yhteensä 14 metriä kaniverkkoa. Miten Arskan pitää valita aitauksensa mitat, jotta kaniaitauksen koko on vähintään 12 neliömetriä?
